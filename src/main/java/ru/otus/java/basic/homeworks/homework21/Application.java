...
public class Application {
    public static void main(String[] args) throws InterruptedException {
        ...
        final int ARRAY_SIZE = 200_000_000;
        ...
        double result1 = (double) (endTime1 - startTime1) / 1000;
        System.out.printf("время заполнения массива: %.2f секунд\n", result1);
        ...
        double result2 = (double) (endTime2 - startTime2) / 1000;
        System.out.printf("%.2f секунд\n", result2);
    }
